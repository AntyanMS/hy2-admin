...
**Ветка `main`** — релизная и **по умолчанию**: в корне — установочные скрипты; подробные инструкции — в **`doc/`**. Полный исходный код веб-панели и вспомогательные материалы — в ветке **`dev`**.
...
Дополнительно (каскад, вспомогательные утилиты): см. ветку **`dev`** репозитория.
