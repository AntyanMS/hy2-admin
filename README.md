...
**Ветка `main`** — релизная и **по умолчанию**: в корне — установочные скрипты и этот обзор; пошаговые инструкции — в каталоге **`doc/`**. Бинарь панели для установки подтягивается с GitHub как **[Latest release](https://github.com/AntyanMS/hy2-admin/releases/latest)** (артефакт `hy2-admin-panel`).
