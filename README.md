...
В панели (начиная с релиза **v0.0.5**) на вкладке **Direct routing** можно подтянуть список доменов из внешнего открытого репозитория и применить их к правилам **direct** (включая IP по DNS):
